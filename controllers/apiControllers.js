...
const addTrainingQuestions = async (req, res) => {
    try {
      const trainingId = req.params.id;
...
const getSessionTrainees = async (req, res) => {
  try {
    const { id } = req.params;
...
const scanSessionQR = async (req, res) => {
  try {
    const { id } = req.params;
    const { phone } = req.body;
...
const submitSessionAttempt = async (req, res) => {
  try {
...
const getTraineeHistory = async (req, res) => {
  try {
...
const getReportsAttempts = async (req, res) => {
  try {
...
const getSessionTraineeAttempts = async (req, res) => {
  try {
    const { id } = req.params;
...
const getSessionsAll = async (req, res) => {
  try {
