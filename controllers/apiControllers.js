...
exports.addQuestionsToTraining = async (req, res) => {
    try {
      const trainingId = req.params.id;
...
exports.enrollTrainees = async (req, res) => {
    try {
      const { id } = req.params;
...
exports.scanSession = async (req, res) => {
  try {
    const { id } = req.params;
    const { phone } = req.body;
...
exports.getTraineeHistory = async (req, res) => {
  try {
...
//reports
exports.getAttemptsReport = async (req, res) => {
  try {
...
exports.getTraineeAttempts = async (req, res) => {
  try {
    const { id } = req.params;
